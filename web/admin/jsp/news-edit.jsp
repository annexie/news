...
<head>
    ...
    <link rel="stylesheet" href="../lib/editor.md/css/style.css"/>
    <link rel="stylesheet" href="../lib/editor.md/lib/codemirror/codemirror.min.css"/>
...
<script src="../lib/editor.md/js/require.min.js"></script>
<script type="text/javascript">
    requirejs.config({
        baseUrl: "../lib/editor.md/lib",
        paths: {
            jquery: "jquery.min",
            marked: "marked.min",
    ...
    require(deps, function (editormd) {
        ...
        // if enable codeFold or <link rel="stylesheet" href="../lib/codemirror/addon/fold/foldgutter.css" />

        editormd.loadCSS("../lib/editor.md/lib/codemirror/addon/fold/foldgutter");

        $.get('../lib/editor.md/test.md', function (md) {
