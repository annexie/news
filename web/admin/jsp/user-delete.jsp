...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <!-- 显示具体的界面信息 start-->
            <div>
                <form class="form-horizontal textFont">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label">预定量:</label>

                        <div class="col-lg-9">
                            <input name="bookingCount" style="display:inline; width:94%;" class="form-control"
                                   type="text"
                                   id="bookingCountID"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">出票量:</label>

                        <div class="col-lg-9">
                            <input name="ticketCount" style="display:inline; width:94%;" class="form-control"
                                   type="text"
                                   id="ticketCountID"/>
                        </div>
                    </div>
